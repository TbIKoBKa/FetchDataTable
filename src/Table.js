        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th onClick = {() => props.toSort('phone')}>Phone {props.sortCol === 'phone' ? (props.sortType === 'asc' ? <span className="sortMark">&uarr;</span> : <span className="sortMark">&darr;</span>) : null}</th>
